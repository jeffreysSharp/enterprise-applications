using Enterprise.Applications.Application.Commands.Role.Create;
using Enterprise.Applications.Application.Commands.Role.Update;
using Enterprise.Applications.Application.DTOs;
using Enterprise.Applications.Application.Queries.Role;
using MediatR;
