...
using Enterprise.Applications.Identity.Infra.Repository.Command.Base;
using Enterprise.Applications.Identity.Infra.Repository.Query.Base;
...
namespace Enterprise.Applications.Infra
{
